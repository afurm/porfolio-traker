  ...
  const metrics = [
    {
      ...
      gradient:
        data.totalROI >= 0 ? 'from-green-500/20 to-green-500/5' : 'from-red-500/20 to-red-500/5',
    },
    {
      title: 'Daily ROI',
      ...
      gradient:
        data.dailyROI >= 0 ? 'from-green-500/20 to-green-500/5' : 'from-red-500/20 to-red-500/5',
    },
    {
      title: 'Weekly ROI',
      ...
      gradient:
        data.weeklyROI >= 0 ? 'from-green-500/20 to-green-500/5' : 'from-red-500/20 to-red-500/5',
    },
    {
      title: 'Monthly ROI',
      ...
      gradient:
        data.monthlyROI >= 0 ? 'from-green-500/20 to-green-500/5' : 'from-red-500/20 to-red-500/5',
    },
    {
      title: 'Risk Score',
