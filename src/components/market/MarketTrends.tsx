          ...
          >
            {gainers.map((coin) => (
              <motion.div
                ...
                className="relative overflow-hidden rounded-lg bg-accent/50 p-4 transition-colors hover:bg-accent"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="relative h-8 w-8 overflow-hidden rounded-full bg-background/50">
                      <Image
                        src={coin.image}
                        alt={coin.name}
                        width={32}
                  ...
                  <div className="text-right">
                    <p className="font-medium text-foreground">{formatCurrency(coin.price)}</p>
