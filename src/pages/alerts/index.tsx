                    ...
                    <div className="space-y-6">
                        ...
                        >
                            ...
                            <div className="relative flex items-center justify-between">
                                ...
                                >
                                    <Button
                                        className="gap-2 bg-gradient-to-r from-red-500 to-purple-500 text-white border-none hover:from-red-600 hover:to-purple-600"
                                    >
                                    ...
                                    {mockAlerts.map((alert) => (
                                        ...
                                        >
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center gap-4">
                                                    <div className={`h-10 w-10 rounded-full flex items-center justify-center ${alert.type === 'price' ? 'bg-blue-500/20' : 'bg-purple-500/20'
                                                        }`}>
                                                        <Icon
                                                            name={alert.type === 'price' ? 'DollarSign' : 'TrendingUp'}
                                                            className={`h-5 w-5 ${alert.type === 'price' ? 'text-blue-400' : 'text-purple-400'
                                                                }`}
                                                        />
                                                    </div>
                                                    <div>
                                                ...
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <Button
                                                        variant="ghost"
                                                        size="sm"
                                                        className={`gap-2 ${alert.isActive
