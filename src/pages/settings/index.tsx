    ...
    <div className="relative min-h-screen bg-[#0d1117]">
      ...
      >
        ...
        >
          ...
          <p className="text-gray-400 mt-2">Customize your Crypto Portfolio experience</p>
        </motion.div>
        ...
        >
          {settingsSections.map((section, sectionIndex) => (
            <motion.div key={section.id} variants={listItem} className="relative group">
                    ...
                    >
                      ...
                      {setting.type === 'select' && (
                        <select
                          ...
                          onChange={(e) => {
                            const path =
                              section.id === 'preferences' ? setting.id : `display.${setting.id}`;
